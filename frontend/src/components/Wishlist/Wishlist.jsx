...
import { removeFromWishlistAction ,addToWishlistAction} from "../../redux/actions/wishlist";
...
console.log("data:::",data)
  console.log("image src:::",`${backend_url}${data?.images[0]}`)
//  http://localhost:5000/gifthamper-1731225760675-26731150.jpg
