   ...
   <>
    {
      adminOrderLoading ? (
        ...
        <div className="w-full flex  items-center justify-between">
          <div className="w-full ml-2 mb-4 min-h-[22vh] bg-white shadow rounded px-2 py-5">
          ...
          <div className="w-full ml-2 mb-4  min-h-[20vh] bg-white shadow rounded px-2 py-5">
            <div className="flex items-center">
          ...
          <div className="w-full mb-4 ml-2  min-h-[20vh] bg-white shadow rounded px-2 py-5">
            <div className="flex items-center">
              <AiOutlineMoneyCollect
                size={30}
                className="mr-2"
